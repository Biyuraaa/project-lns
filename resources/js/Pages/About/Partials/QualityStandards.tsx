...
// Props 'isInView' dan 'fadeIn' sudah tidak diperlukan lagi
const VisionMissionSection = () => {
    // Definisikan semua varian animasi di dalam komponen
    const fadeIn = {
        ...
        <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-20 md:py-28 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
                <motion.div
                    ...
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.2 }} // Memicu saat 20% elemen terlihat
                    transition={{ staggerChildren: 0.2 }} // Memberi jeda animasi untuk elemen anak
                >
