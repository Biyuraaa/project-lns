...
const PicEngineersCreate = () => {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Create PIC Engineer" />
            <Breadcrumb
                items={[
                    {
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between">
                            <div className="mb-6 md:mb-0">
                                <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center">
                                    ...
                                    Create New PIC Engineer
                                </h1>
                                <p className="mt-1.5 max-w-2xl text-blue-100 text-lg">
                                    Add a new PIC Engineer to your database
                                </p>
                                <div className="mt-4 flex flex-wrap gap-2">
                                    ...
                                    >
                                        ...
                                        <span>New Engineering Team Member</span>
                                    </Badge>
                                    <Badge
                                        variant="outline"
                                        className="bg-white/10 text-white border-white/20 backdrop-blur-sm px-2.5 py-1 flex items-center gap-1.5"
                            ...
                            <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-blue-700">
                                    ...
                                    <p className="mt-1">
                                        ...
                                        with at least 8 characters, including
...
export default PicEngineersCreate;
