...
const CustomersIndex = () => {
    const { customers } = usePage<CustomersIndexProps>().props;
    ...
    const currentCustomers = pagination.paginateData(sortedCustomers);
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between">
                            <div className="mb-6 md:mb-0">
                                ...
                                <p className="mt-1.5 max-w-2xl text-blue-100 text-lg">
                                    Manage all your customers in one place with
                                            ...
                                            (customer, index) => (
                                                ...
                                                >
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            <div
                                                                className={`h-10 w-10 rounded-lg bg-gradient-to-br ${getAvatarColor(
                                                                    customer.name
                                            ...
                                            >
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <p className="text-gray-500 mb-6 max-w-md mx-auto">
                                                        {searchTerm
                                                            ? "Try adjusting your search or clear it to see all customers"
                                                            : "Create your first customer to get started managing your customer relationships"}
                                                    </p>
