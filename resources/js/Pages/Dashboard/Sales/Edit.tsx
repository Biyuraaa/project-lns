...
const SalesEdit = () => {
    const { sales } = usePage<SalesEditProps>().props;
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(
        sales.image ? `/storage/images/sales/${sales.image}` : null
    );
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.post(route("sales.update", sales.id), formData, {
            onError: (errors) => {
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Hero Section */}
                    <div className="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-700 p-8 shadow-xl">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between">
                            <div className="mb-6 md:mb-0">
                                <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center">
                                    ...
                                    Edit Sales Person: {sales.name}
                                </h1>
                                <p className="mt-1.5 max-w-2xl text-blue-100 text-lg">
                                    Update the sales team member's information
                                </p>
                                    ...
                                    <div className="space-y-1 md:col-span-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Textarea
                                                ...
                                                placeholder="Enter sales person's address"
                                            />
                                        </div>
                                        {errors.address && (
                                            <p className="text-red-500 text-xs mt-1 flex items-center">
